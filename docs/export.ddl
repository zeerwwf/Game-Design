...
ALTER TABLE EstablishmentRating ADD CONSTRAINT EstablishmentR_Esta_FK FOREIGN KEY ( Establishment_Id ) REFERENCES Establishment ( Id ) ON
DELETE CASCADE ;

ALTER TABLE EstablishmentRating ADD CONSTRAINT EstablishmentRating_Client_FK FOREIGN KEY ( Client_Id ) REFERENCES Client ( Id ) ON
DELETE CASCADE ;
